...
dotnet script ./GradientSoftware.GithubScripts/.github/scripts/update-version.csx %GITHUB_USERNAME% GradientSoftware.Utils %GITHUB_APIKEY% ./GoogleLibrary/GoogleLibrary.csproj %branch%
